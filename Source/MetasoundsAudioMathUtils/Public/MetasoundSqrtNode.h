...
namespace Metasound
{
	...
	public:
		...
		FSqrtNode(FNodeData InNodeData, TSharedRef<const FNodeClassMetadata> InClassMetadata)
			: FNodeFacade(InNodeData, InClassMetadata, TFacadeOperatorClass<FSqrtOperator>())
		{
